 ...
 */
public class ASDNewickTreeExportHandler extends AlleleSharingDistanceMatrixExportHandler implements ExperimentalFeature {

    public ASDNewickTreeExportHandler() {
    }
    
    public ASDNewickTreeExportHandler(int nMaxMissingDataPercentageForIndividuals) {
    ...
    public String getExportFormatDescription() {
    	return "Exports a zipped <a target='_blank' href='https://en.wikipedia.org/wiki/Newick_format'>Newick</a> file containing an Allele Sharing Distance (ASD) neighbour-joining tree based on an Eigenstrat format export. Individuals with more than 50% missing data are automatically excluded.";
    }
